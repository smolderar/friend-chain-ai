...
class _Field2 {
    constructor(Fp, opts = {}) {
        ...
        this.Fp_div2 = Fp.div(Fp.ONE, _2n$1); // 1/2
...
class _Field12 {
    ...
    _cyclotomicSquare({ c0, c1 }) {
        ...
        return {
            c0: Fp6.create({
                c0: Fp2.add(Fp2.mul(Fp2.sub(t3, c0c0), _2n$1), t3), // 2 * (T3 - c0c0)  + T3
                c1: Fp2.add(Fp2.mul(Fp2.sub(t5, c0c1), _2n$1), t5), // 2 * (T5 - c0c1)  + T5
                c2: Fp2.add(Fp2.mul(Fp2.sub(t7, c0c2), _2n$1), t7),
            }), // 2 * (T7 - c0c2)  + T7
            c1: Fp6.create({
                c0: Fp2.add(Fp2.mul(Fp2.add(t9, c1c0), _2n$1), t9), // 2 * (T9 + c1c0) + T9
                c1: Fp2.add(Fp2.mul(Fp2.add(t4, c1c1), _2n$1), t4), // 2 * (T4 + c1c1) + T4
...
const { Fp, Fp2: Fp2$1, Fp6, Fp12: Fp12$1 } = tower12({
...
const AuthV3Circuit = 'authV3';
const AuthV3_8_32Circuit = 'authV3-8-32';
...
class ProvingMethodGroth16AuthV3 {
    methodAlg;
    static curveName = 'bn128';
    constructor(methodAlg) {
        this.methodAlg = methodAlg;
...
const provingMethodGroth16AuthV3Instance = new ProvingMethodGroth16AuthV3(new ProvingMethodAlg(Groth16, AuthV3Circuit));
const provingMethodGroth16AuthV3_8_32Instance = new ProvingMethodGroth16AuthV3(new ProvingMethodAlg(Groth16, AuthV3_8_32Circuit));
