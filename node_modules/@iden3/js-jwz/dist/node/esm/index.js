...
import { fromBigEndian as fromBigEndian2 } from "@iden3/js-iden3-core";
...
var [G1PP, G2PP] = [bn254.G1.ProjectivePoint, bn254.G2.ProjectivePoint];
...
async function verify(messageHash, proof, verificationKey, unmarshall) {
  ...
  if (outputs.challenge !== fromBigEndian2(messageHash)) {
...
import { Id as Id2 } from "@iden3/js-iden3-core";
...
var ProvingMethodGroth16AuthV2 = class _ProvingMethodGroth16AuthV2 {
  ...
  async terminateCurve() {
    const curve = await getCurveFromName(_ProvingMethodGroth16AuthV2.curveName);
    curve.terminate();
  }
  unmarshall(pubSignals) {
    const len = 3;
    ...
    return {
      userID: Id2.fromBigInt(BigInt(pubSignals[0])),
...
// src/authV3Groth16.ts
import { Id as Id3 } from "@iden3/js-iden3-core";
import { Hash as Hash2 } from "@iden3/js-merkletree";
import { getCurveFromName as getCurveFromName2 } from "ffjavascript";
var AuthV3Groth16Alg = new ProvingMethodAlg(Groth16, AuthV3Circuit);
var AuthV3_8_32Groth16Alg = new ProvingMethodAlg(Groth16, AuthV3_8_32Circuit);
var ProvingMethodGroth16AuthV3 = class _ProvingMethodGroth16AuthV3 {
  constructor(methodAlg) {
    this.methodAlg = methodAlg;
  }
  static curveName = "bn128";
  ...
  async terminateCurve() {
    const curve = await getCurveFromName2(_ProvingMethodGroth16AuthV3.curveName);
    curve.terminate();
  }
  unmarshall(pubSignals) {
    const len = 3;
    ...
    return {
      userID: Id3.fromBigInt(BigInt(pubSignals[0])),
      challenge: BigInt(pubSignals[1]),
      GISTRoot: Hash2.fromString(pubSignals[2])
    };
  }
};
var provingMethodGroth16AuthV3Instance = new ProvingMethodGroth16AuthV3(
