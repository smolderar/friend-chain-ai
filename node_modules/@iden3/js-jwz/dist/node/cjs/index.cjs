...
var ProvingMethodGroth16AuthV3 = class _ProvingMethodGroth16AuthV3 {
  ...
  async terminateCurve() {
    const curve = await (0, import_ffjavascript2.getCurveFromName)(_ProvingMethodGroth16AuthV3.curveName);
    curve.terminate();
  }
  unmarshall(pubSignals) {
    const len = 3;
    ...
    return {
      userID: import_js_iden3_core6.Id.fromBigInt(BigInt(pubSignals[0])),
      challenge: BigInt(pubSignals[1]),
      GISTRoot: import_js_merkletree2.Hash.fromString(pubSignals[2])
    };
  }
};
