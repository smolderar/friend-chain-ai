...
function calculateGroupId(requestIds) {
  ...
  const groupID = BigInt(ethers9.keccak256(ethers9.solidityPacked(types, requestIds))) & // It should fit in a field number in the circuit (max 253 bits). With this we truncate to 252 bits for the group ID
  BigInt("0x0FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
  return groupID;
}
