...
function calculateGroupId(requestIds) {
  ...
  const groupID = BigInt(import_ethers15.ethers.keccak256(import_ethers15.ethers.solidityPacked(types, requestIds))) & // It should fit in a field number in the circuit (max 253 bits). With this we truncate to 252 bits for the group ID
  BigInt("0x0FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF");
  return groupID;
}
