...
const js_sdk_2 = require("@0xpolygonid/js-sdk");
/**
...
class EthStateResolver {
    ...
    constructor(rpcUrl, contractAddress, options) {
        ...
        this._stateResolveCache =
            options?.stateCacheOptions?.cache ??
                (0, js_sdk_1.createInMemoryCache)({
    ...
    async performResolve(id, state) {
        ...
        try {
            ...
            if ((0, js_sdk_2.isStateDoesNotExistError)(e)) {
                if (isGenesis) {
                    return {
                        latest: true,
                        genesis: isGenesis,
    ...
    async performRootResolve(root) {
        ...
        try {
            ...
            if ((0, js_sdk_2.isRootDoesNotExistError)(e)) {
