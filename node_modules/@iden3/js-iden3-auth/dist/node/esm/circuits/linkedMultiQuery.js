...
import { LinkedMultiQueryPubSignals, byteEncoder, cacheLoader, parseQueriesMetadata, calculateQueryHashV3, calculateCoreSchemaHash, Operators, fieldValueFromVerifiablePresentation } from '@0xpolygonid/js-sdk';
/**
 * Verifies the linked multi-query circuit.
 * @beta
 */
export class LinkedMultiQueryVerifier {
    constructor(pubSignals, opts) {
